...
Ramen costs <Stat>$0.25</Stat> at most prison commissaries. It is, by weight, the cheapest available source of calories in the carceral economy. It is also, by transaction frequency, the most exchanged unit of currency.
...
<PullQuote>Two ramens pay for a magazine kept. Five ramens pay for a tattoo of approximately one square inch.</PullQuote>
