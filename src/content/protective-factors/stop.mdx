...
<LetterCallout letter="S" action="Stop">
...
<LetterCallout letter="T" action="Take a step back">
...
<LetterCallout letter="O" action="Observe">
...
<LetterCallout letter="P" action="Proceed mindfully">
