...
heroImage: "../../assets/protective-factors-abcplease-hero.png"
---

import { Image } from 'astro:assets';
import abcplease01 from '../../assets/protective-factors-abcplease-01.png';
import abcplease02 from '../../assets/protective-factors-abcplease-02.png';
...
<Image
  src={abcplease01}
  alt="Illustration: a flowing abstract painting of rainbow waves and layered bands in warm oranges, deep blues, and greens — a gathering of color, the visual of accumulation."
...
<Image
  src={abcplease02}
  alt="Illustration: a dense, color-saturated painting of interlocking mandala and mosaic patterns — geometric tilework, spirals, and intricate fine detail in oranges, blues, and greens."
  class="article-figure"
  widths={[480, 680, 1360]}
  sizes="(min-width: 960px) 680px, 100vw"
  format="webp"
